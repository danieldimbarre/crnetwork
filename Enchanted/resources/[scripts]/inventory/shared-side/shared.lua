...
-----------------------------------------------------------------------------------------------------------------------------------------
Single = {
	{ Coords = vec4(256.35,-47.51,69.7,249.76), Mode = "Ammunation" },
	{ Coords = vec4(846.13,-1036.62,27.95,178.74), Mode = "Ammunation" },
	{ Coords = vec4(-335.18,6083.29,31.21,45.57), Mode = "Ammunation" },
	{ Coords = vec4(-665.98,-932.24,21.58,358.38), Mode = "Ammunation" },
	{ Coords = vec4(-1301.93,-391.36,36.45,255.85), Mode = "Ammunation" },
	{ Coords = vec4(-1122.59,2698.25,18.31,42.82), Mode = "Ammunation" },
	{ Coords = vec4(2571.67,291.28,108.49,180.02), Mode = "Ammunation" },
	{ Coords = vec4(2571.66,291.29,108.49,181.06), Mode = "Ammunation" },
	{ Coords = vec4(19.57,-1103.0,29.55,339.07), Mode = "Ammunation" },
	{ Coords = vec4(813.92,-2160.34,29.37,179.33), Mode = "Ammunation" },
	{ Coords = vec4(1688.78,3759.13,34.46,47.5), Mode = "Ammunation" },

	{ Coords = vec4(28.18,-1338.55,29.24,359.45), Mode = "Department" },
	{ Coords = vec4(2548.61,384.87,108.36,87.98), Mode = "Department" },
	{ Coords = vec4(1159.12,-316.72,68.95,100.36), Mode = "Department" },
	{ Coords = vec4(-710.58,-906.72,18.96,90.17), Mode = "Department" },
	{ Coords = vec4(-45.73,-1749.8,29.17,50.77), Mode = "Department" },
	{ Coords = vec4(378.3,334.01,103.31,346.27), Mode = "Department" },
	{ Coords = vec4(-3250.66,1004.43,12.57,85.32), Mode = "Department" },
	{ Coords = vec4(1735.06,6421.41,34.78,333.6), Mode = "Department" },
	{ Coords = vec4(546.53,2662.18,41.89,186.7), Mode = "Department" },
	{ Coords = vec4(1958.93,3749.46,32.09,30.17), Mode = "Department" },
	{ Coords = vec4(2672.21,3286.9,54.98,61.68), Mode = "Department" },
	{ Coords = vec4(1706.27,4922.6,41.81,324.6), Mode = "Department" },
	{ Coords = vec4(-1828.06,796.31,137.93,132.2), Mode = "Department" },
	{ Coords = vec4(-3048.43,585.41,7.66,106.96), Mode = "Department" }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- MULTIPLIER
-----------------------------------------------------------------------------------------------------------------------------------------
Multiplier = {
	...
	{ Coords = vec4(33.19,-1348.80,29.49), Mode = "Eletronic" },
	{ Coords = vec4(2559.05,389.47,108.62), Mode = "Eletronic" },
	{ Coords = vec4(1153.11,-326.90,69.20), Mode = "Eletronic" },
	{ Coords = vec4(-718.26,-915.71,19.21), Mode = "Eletronic" },
	{ Coords = vec4(-57.40,-1751.74,29.42), Mode = "Eletronic" },
	{ Coords = vec4(380.65,322.84,103.56), Mode = "Eletronic" },
	{ Coords = vec4(-3240.02,1008.54,12.83), Mode = "Eletronic" },
	{ Coords = vec4(1735.01,6410.00,35.03), Mode = "Eletronic" },
	{ Coords = vec4(540.22,2671.68,42.15), Mode = "Eletronic" },
	{ Coords = vec4(1968.39,3743.07,32.34), Mode = "Eletronic" },
	{ Coords = vec4(2683.59,3286.30,55.24), Mode = "Eletronic" },
	{ Coords = vec4(1703.31,4934.05,42.06), Mode = "Eletronic" },
	{ Coords = vec4(-1827.68,784.46,138.31), Mode = "Eletronic" },
	{ Coords = vec4(-3040.20,593.29,7.90), Mode = "Eletronic" }
}