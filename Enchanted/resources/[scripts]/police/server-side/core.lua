...
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.DashboardRemoveMessage(Number)
	local source = source
...
-- SEARCH
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.Search(Number)
	local source = source
...
-- PERSONAL
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.Personal(Number)
	local source = source
	local Number = parseInt(Number)
	local Passport = vRP.Passport(source)
	if Passport and not Active[Passport] and vRP.HasService(Passport,"Policia") then
...
-- PRISON
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.Prison(Table)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and not Active[Passport] and vRP.HasService(Passport,"Policia") then
		Active[Passport] = true
...
-- BADGE
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.Badge(Number)
	local source = source
	local Number = parseInt(Number)
	local Passport = vRP.Passport(source)
...
-- MESSAGE
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.Message(Message)
	local source = source
	local Passport = vRP.Passport(source)
...
-- COURSES
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.Courses(Table)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and vRP.HasGroup(Passport,"Policia",2) then
