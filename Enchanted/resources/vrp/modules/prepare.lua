...
vRP.Prepare("characters/NewCharacter","INSERT INTO characters(License,Name,Lastname,Sex,Skin,Blood,Created) VALUES(@License,@Name,@Lastname,@Sex,@Skin,@Blood,UNIX_TIMESTAMP() + 259200)")
-----------------------------------------------------------------------------------------------------------------------------------------
-- SMARTPHONE
-----------------------------------------------------------------------------------------------------------------------------------------
...
vRP.Prepare("accounts/UpgradePremium","UPDATE accounts SET Premium = (Premium + 2592000), Level = @Level WHERE License = @License")
vRP.Prepare("accounts/Minimals","SELECT * FROM accounts WHERE (Login + 1296000) <= UNIX_TIMESTAMP() AND License <> 0 AND Whitelist = 1")
-----------------------------------------------------------------------------------------------------------------------------------------
-- PLAYERDATA
-----------------------------------------------------------------------------------------------------------------------------------------
