...
local List = {
	...
	["12"] = {2421.64,3125.33,36.87,"Families" },---------------MOTO CLUBE DISMANCHE, ALGEMA-------
	["13"] = { 1388.17,3604.86,38.94,"Vagos" }, ----------------VAGOS META, LOCKPICK,---------
	["14"] = { 441.79,6462.3,35.86,"Cartel" }, --------------------------CARTEL ARMAS-----
	["16"] = { 2327.74,2569.72,46.67,"Triads" }, -------------------------MAFIA ARMAS-----
	["17"] = { 2198.08,5599.46,53.7,"Bloods" },---------------MACONHA,CAPUZ,------------
	["18"] = { 1172.01,2709.05,38.08,"Marabunta" },------------MARABUNTA LAVAGEM, C4 ---------------
	["19"] = { 3817.06,4441.44,2.81,"Aztecas" },----------MEXICO EQUIPAMENTOS,PAGE--------
