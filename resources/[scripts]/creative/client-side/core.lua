...
local blips = {
	...
	{ 825.33,-1290.15,28.24,60,18,"Departamento Policial",0.6 },
	...
	{ -1598.3,5197.18,4.08,86,62,"Pescador",0.4 },
	{ 2057.89,5109.83,46.34,76,62,"Agricultor",0.4 },
	{ -1178.2,-880.6,13.92,106,62,"BurgerShot",0.6 },
...
local Teleport = {
	...
	{ 254.22,225.46,101.87,253.27,223.05,101.67 },
	{ 253.27,223.05,101.67,254.22,225.46,101.87 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSTART
-----------------------------------------------------------------------------------------------------------------------------------------
