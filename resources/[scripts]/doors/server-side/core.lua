...
GlobalState["Doors"] = {
	...
	[160] = { Coords = vec3(472.95,-103.77,63.30), Hash = -350302570, Lock = true, Text = true, Distance = 1.5, Perm = "Razors", Other = 161 },
	[161] = { Coords = vec3(475.15,-104.57,63.30), Hash = -104698915, Lock = true, Text = true, Distance = 1.5, Perm = "Razors", Other = 160 },
