		...
		if not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Handcuff"] and not menuOpen and LocalPlayer["state"]["Network"] and LocalPlayer["state"]["Route"] < 900000 then
			...
			if GetEntityHealth(Ped) > 100 then
				...
				if LocalPlayer["state"]["Police"] then
					...
					exports["dynamic"]:AddButton("Polícia","Fardamento de policial.","player:presetFunctions","1","prePolice",true)
					exports["dynamic"]:AddButton("GOE","Fardamento de policial.","player:presetFunctions","2","prePolice",true)
					exports["dynamic"]:AddButton("GTM","Fardamento de policial.","player:presetFunctions","3","prePolice",true)
					exports["dynamic"]:AddButton("GAR","Fardamento de policial.","player:presetFunctions","4","prePolice",true)
					exports["dynamic"]:AddButton("GIP","Fardamento de policial.","player:presetFunctions","5","prePolice",true)
					exports["dynamic"]:AddButton("GRAER","Fardamento de policial.","player:presetFunctions","6","prePolice",true)
					exports["dynamic"]:AddButton("Penal","Fardamento de policial.","player:presetFunctions","7","prePolice",true)
				...
				elseif LocalPlayer["state"]["Paramedic"] then
					exports["dynamic"]:AddButton("Medical Center","Fardamento de doutor.","player:presetFunctions","8","preMedic",true)
					exports["dynamic"]:AddButton("Medical Center","Fardamento de paramédico.","player:presetFunctions","9","preMedic",true)
					exports["dynamic"]:AddButton("Medical Center","Fardamento de paramédico interno.","player:presetFunctions","10","preMedic",true)
					exports["dynamic"]:AddButton("Medical Center","Fardamento de atendimentos.","player:presetFunctions","11","preMedic",true)
					exports["dynamic"]:AddButton("Medical Center","Fardamento de mergulhador.","player:presetFunctions","12","preMedic",true)
