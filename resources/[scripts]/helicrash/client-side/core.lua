...
AddEventHandler("firework:Battery",function(Coords)
	...
	repeat
		...
		StartNetworkedParticleFxNonLoopedAtCoord("scr_indep_firework_trailburst",Coords,0.0,0.0,0.0,math.random() * 0.5 + 0.8,false,false,false,false)
		Wait(1500)
		UseParticleFxAsset(FxAsset)
		SetParticleFxNonLoopedColour(math.random(),math.random(),math.random())
		StartNetworkedParticleFxNonLoopedAtCoord("scr_indep_firework_trailburst",Coords,0.0,0.0,0.0,math.random() * 0.5 + 0.8,false,false,false,false)
...
AddEventHandler("firework:Fountain",function(Coords)
	...
	repeat
		UseParticleFxAsset(FxAsset)
		SetParticleFxNonLoopedColour(math.random(),math.random(),math.random())
		StartNetworkedParticleFxNonLoopedAtCoord("scr_indep_firework_fountain",Coords,0.0,0.0,0.0,math.random() * 0.5 + 0.8,false,false,false,false)
		Wait(1500)
		UseParticleFxAsset(FxAsset)
		SetParticleFxNonLoopedColour(math.random(),math.random(),math.random())
		StartNetworkedParticleFxNonLoopedAtCoord("scr_indep_firework_fountain",Coords,0.0,0.0,0.0,math.random() * 0.5 + 0.8,false,false,false,false)
		...
		UseParticleFxAsset(FxAsset)
		SetParticleFxNonLoopedColour(math.random(),math.random(),math.random())
		StartNetworkedParticleFxNonLoopedAtCoord("scr_indep_firework_fountain",Coords,0.0,0.0,0.0,math.random() * 1.5 + 1.8,false,false,false,false)
		Wait(2500)
		UseParticleFxAsset(FxAsset)
		SetParticleFxNonLoopedColour(math.random(),math.random(),math.random())
		StartNetworkedParticleFxNonLoopedAtCoord("scr_indep_firework_fountain",Coords,0.0,0.0,0.0,math.random() * 1.5 + 1.8,false,false,false,false)
