...
local shops = {
	...
	["Police"] = {
		...
		["List"] = {
			...
			["handcuff"] = 425,
			["WEAPON_SMG"] = 775,
			["WEAPON_PUMPSHOTGUN"] = 5775,
			["WEAPON_PARAFAL"] = 7000,
			["WEAPON_CARBINERIFLE"] = 1775,
			["WEAPON_CARBINERIFLE_MK2"] = 1925,
			["WEAPON_STUNGUN"] = 525,
			["WEAPON_COMBATPISTOL"] = 1025,
			["WEAPON_HEAVYPISTOL"] = 1225,
			["WEAPON_NIGHTSTICK"] = 125,
			["WEAPON_PISTOL_AMMO"] = 6,
			["WEAPON_SMG_AMMO"] = 10,
			["WEAPON_RIFLE_AMMO"] = 15,
			["WEAPON_SHOTGUN_AMMO"] = 20,
			["badge01"] = 10,
			["WEAPON_MOLOTOV"] = 5000,
			["WEAPON_SMOKEGRENADE"] = 75,
			["attachsFlashlight"] = 3750,
			["attachsCrosshair"] = 3750,
			["attachsSilencer"] = 3750,
			["attachsMagazine"] = 3750,
			["attachsGrip"] = 3750,
			["megaphone"] = 1025
		}
	},
