...
local Chairs = {
	...
	-- Bean Machine
	{ ["Coords"] = vec3(117.7,-1032.67,28.80), ["Heading"] = 260.79 },
	{ ["Coords"] = vec3(117.34,-1033.51,28.80), ["Heading"] = 260.79 },
	{ ["Coords"] = vec3(117.09,-1034.37,28.80), ["Heading"] = 260.79 },
	-- Police
	{ ["Coords"] = vec3(459.43,-980.58,30.20), ["Heading"] = 269.3 },
	{ ["Coords"] = vec3(459.49,-981.67,30.20), ["Heading"] = 269.3 },
	{ ["Coords"] = vec3(461.08,-990.79,30.20), ["Heading"] = 0.0 },
	{ ["Coords"] = vec3(462.22,-990.79,30.20), ["Heading"] = 0.0 },
	{ ["Coords"] = vec3(440.26,-975.37,34.45), ["Heading"] = 272.13 },
	{ ["Coords"] = vec3(440.25,-974.18,34.45), ["Heading"] = 272.13 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSTART
-----------------------------------------------------------------------------------------------------------------------------------------
