					...
					if distance <= works[inService]["collectShowDistance"] then
						...
						if distance <= works[inService]["collectButtonDistance"] and inSeconds <= 0 and IsControlJustPressed(1,38) then
							...
							if works[inService]["collectAnim"] ~= nil then
								...
								if works[inService]["collectAnim"][5] then
									vRP.createObjects(works[inService]["collectAnim"][1],works[inService]["collectAnim"][2],works[inService]["collectAnim"][3],works[inService]["collectAnim"][4],works[inService]["collectAnim"][5])
								else
...
-- UPDATEWORKS
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.updateWorks(status)
	works = status
